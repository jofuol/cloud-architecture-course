# **Set Up Network Load Balancers _([GSP007][Link_to_lab_on_google_skills]{:target="_blank"})_**
![google-cloud-self-paced-labs][google-cloud-self-paced-labs]
...
There are several ways you can [load balance on Google Cloud][load-balance-on-google-cloud]{:target="_blank"}. This lab takes you through the setup of the following load balancers:

- [Network Load Balancer][network-load-balancer-overview]{:target="_blank"}
...
!!! Note
    ...
    **Note:** To access Google Cloud products and services, click the **Navigation menu** or type the service or product name in the **Search** field.
    ![gcp-search.png][gcp-search]

### Activate Cloud Shell

Cloud Shell is a virtual machine that is loaded with development tools. It offers a persistent 5GB home directory and runs on the Google Cloud. Cloud Shell provides command-line access to your Google Cloud resources.

1. Click Activate Cloud Shell **Activate Cloud Shell** ![shell-icon.png][shell-icon] at the top of the Google Cloud console.
...
!!! Note
    ...
    **Note:** For full documentation of `gcloud`, in Google Cloud, refer to [the gcloud CLI overview guide][gcloud-cli-overview-guide]{:target="_blank"}.
...
- [Set up an external passthrough Network Load Balancer with a backend service][gcp-backend-service-based-external-passthrough-network-load-balancer-overview]{:target="_blank"}

### Google Cloud training and certification

...helps you make the most of Google Cloud technologies. [Our classes][gcp-classes]{:target="_blank"} include technical skills and best practices to help you get up to speed quickly and continue your learning journey. We offer fundamental to advanced level training, with on-demand, live, and virtual options to suit your busy schedule. [Certifications][certifications]{:target="_blank"} help you validate and prove your skill and expertise in Google Cloud technologies.

**Manual Last Updated July 17, 2025**
...
[gcp-classes]: https://cloud.google.com/training
[certifications]: https://cloud.google.com/certification/

[google-cloud-self-paced-labs]: ../../../assets/common/google-cloud-self-paced-labs.png
[shell-icon]: ../../../assets/images/google-skills/network-load-balancers/shell-icon.png
[gcp-search]: ../../../assets/images/google-skills/network-load-balancers/gcp-search.png